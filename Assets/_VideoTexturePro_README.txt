...
CHANGELOG: 
------------------------------------------------------------------------------------------------------------------------ 
2.2.4 : fix bug with color swapping introduced with YUV support fix, fixes OnDestroy bug if you destroy a VideoTexture without enabling it first.
2.2.3 : added a modified YUV shader for YUV mode to support ES 3.0 with LUMINANCE enums
2.2.2 : fixed support for OpenGL ES 3.0 in YUV mode on iOS - GL_RED_EXT and GL_RG_EXT needed to be GL_LUMINANCE and GL_LUMINANCE_EXT. also added https:// support
2.2.1 : fixed a second regression introduced in 2.1.9
2.2.0 : fixed a regression I introduced in 2.1.9 regarding the iOS build path
